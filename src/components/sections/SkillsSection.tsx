...
function SkillNode({ skill, color, index }: SkillNodeProps) {
...
export function SkillsSection() {
  return (
    <section id="skills" className="py-24 px-4 bg-terminal-surface/30">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-0">
          ...
          <ScrollReveal delay={0.1}>
            <div className="flex items-center gap-4 mb-6 font-mono text-xs text-text-muted">
              <div className="flex items-center gap-2">
                <span
                  className="w-3 h-3 rounded-full border-2 ring-2 ring-offset-2 ring-offset-terminal-bg"
                  style={{ borderColor: "#e6edf3", backgroundColor: "#e6edf3", outline: "2px solid #e6edf3", outlineOffset: "2px" }}
                />
        ...
        <ScrollReveal delay={0.6}>
          <div className="mt-8 p-4 rounded-xl border border-terminal-border bg-terminal-surface font-mono text-xs text-text-faint">
